...
#
# This turns out to be a pretty good description of both micro and macro income dynamics, and provides a particularly clear starting point for thinking about the dynamics of income and consumption.
#
...
filename='./rbc_friedman_k-as-state.yaml'
filename='./rbc_friedman_m-as-state.yaml'
# %cat $filename 
